...
#cols = t.columns
#cols = ["A_IMAGE", "B_IMAGE", "XMAX_IMAGE-XMIN_IMAGE", "YMAX_IMAGE-YMIN_IMAGE", "A_WORLD", "B_WORLD", "ISOAREA_WORLD", "ISOAREA_IMAGE", "ISOAREAF_IMAGE", "KRON_RADIUS", "PETRO_RADIUS", "FWHM_IMAGE", "FWHM_WORLD", "THETA_IMAGE", "ELONGATION", "FLUX_RADIUS", "AMODEL_IMAGE", "BMODEL_IMAGE", "THETAMODEL_IMAGE", "AMODEL_WORLD", "BMODEL_WORLD", "THETAMODEL_J2000", "THETA_J2000", "ISOAREAF_WORLD"]
#cols = ["BMODEL_WORLD"]
#bands = ["g", "r", "i", "z", "Y"]
#file_start = "DES0332-2749_"
#file_end = "_cat.fits"

def make_hist(xs, col, units, comment, band, file_start, out_path, zoom = False, save = True):
	fig = plt.figure()
...
def histograms(dir, file_start, file_end, cols, bands, out_path, zoom = False, save = True):
...
#	t = Table.read("/data/desardata/SVA1/" + file_start[:-1] + "/" + file_start + "i" + file_end)
#	cols = t.columns
#	histograms("/data/desardata/SVA1/" + file_start[:-1] + "/", file_start, file_end, cols, bands, zoom = True)
